...
public class SphinxNode_Test {
    ...
    public void aesCtrEncrypt() throws Exception {
        ...
        Header inputHeader = new Header();
        inputHeader.alpha = inputAlpha;
        inputHeader.beta = inputBeta;
        inputHeader.gamma = inputGamma;

        HeaderAndDelta inputHeaderAndDelta = new HeaderAndDelta();
        inputHeaderAndDelta.header = inputHeader;
        inputHeaderAndDelta.delta = inputDelta;
